export const rooms = [
  {
    ...
    shortDescription:
      "A contemporary king room with a clean layout and refined finishes.",

    description:
      "A contemporary take on the Savannah stay, the Classic King pairs a king bed with a thoughtfully considered layout and refined finishes. Comfortable for one or two guests, it offers a calm place to return to between mornings in the squares, afternoons spent exploring, and evenings out in the city.",
    ...
    amenities: [
      ...
      "Mini-Fridge",
      "Non-smoking",
      "Dual Charging Port Alarm Clock",
      "Safe",
      "Shower Only",
      "Wi-Fi",
    ],
