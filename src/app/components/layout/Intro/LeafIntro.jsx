...
const SECTION_CLASSES =
  "relative isolate min-h-[36rem] overflow-hidden px-5 py-16 sm:min-h-[40rem] sm:px-8 sm:py-20 md:min-h-285 md:px-10 md:py-24";
...
const HEADING_CLASSES =
  "max-w-xl md:max-w-3xl text-balance font-serif text-4xl leading-[1.05] tracking-tight text-stone-900 italic sm:text-5xl lg:text-6xl";

const INTRO_CLASSES =
  "mt-6 max-w-lg text-pretty text-base leading-7 text-stone-800 sm:mt-8 sm:text-xl sm:leading-8";
