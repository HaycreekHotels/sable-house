...
export default function PrivacyClient() {
  ...
  return (
    <main
      ref={pageRef}
      className="bg-[#f5f3ee] font-benton-regular text-[#1e1e1a]"
    >
        ...
        <div className="absolute inset-0 flex items-end">
          <div className="mx-auto w-full max-w-6xl px-5 pb-12 md:px-8 md:pb-16 lg:pb-20">
            <div data-hero-copy className="max-w-2xl translate-y-6 opacity-0">
              <p className="mb-3 text-[11px] font-central-regular uppercase tracking-[0.3em] text-white/80 md:text-xs">
                The Sabal House
              </p>
              ...
              <p className="mt-4 max-w-xl text-sm font-central-regular leading-7 text-white/85 md:text-base">
      ...
      <section className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-24">
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16">
          <div data-reveal>
            <p className="text-[11px] uppercase font-central-regular tracking-[0.28em] text-[#6c6a63] md:text-xs">
              Privacy policy
            </p>
          ...
          <div
            data-reveal
            className="space-y-5 text-sm leading-7 font-central-regular text-[#4f4d46] md:text-base"
          >
            <p>
              The Sabal House values your privacy and is committed to handling
      ...
      <section className="border-y border-black/10 bg-white/70">
        <div className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-24">
          <div data-reveal className="max-w-2xl">
            <p className="text-[11px] uppercase tracking-[0.28em] font-central-regular text-[#6c6a63] md:text-xs">
              Overview
            </p>
            <h2 className="mt-3 text-3xl font-benton-regular md:text-4xl">
              How we handle information
            </h2>
            <p className="mt-4 text-sm leading-7 font-central-regular text-[#4f4d46] md:text-base">
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {privacySections.map((item) => (
              ...
              >
                ...
                <p className="mt-3 text-sm leading-7 font-central-regular text-[#4f4d46]">
                  {item.body}
                </p>
              </article>
            ))}
      ...
      <section className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-24">
        <div className="grid gap-5 lg:grid-cols-2">
          ...
          >
            <p className="text-[11px] font-central-regular uppercase tracking-[0.28em] text-white/60 md:text-xs">
              Retention
            </p>
            <h2 className="mt-3 text-2xl font-benton-regular md:text-3xl">
              Data Retention & Legal Requests
            </h2>
            <p className="mt-4 text-sm leading-7 font-central-regular text-white/75 md:text-base">
      ...
      <section className="bg-[#ece8df]">
        <div className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-24">
          <div className="grid gap-10 lg:grid-cols-[1fr_0.8fr] lg:gap-16">
            <div data-reveal>
              <p className="text-[11px] font-central-regular uppercase tracking-[0.28em] text-[#6c6a63] md:text-xs">
                Questions
              </p>
              ...
              <p className="mt-5 max-w-2xl font-central-regular text-sm leading-7 text-[#4f4d46] md:text-base">
            ...
            >
              ...
              <div className="mt-8 border-t border-black/10 pt-6">
                <p className="text-sm uppercase font-central-regular tracking-[0.22em] text-[#6c6a63]">
                  Privacy contact
                </p>
                <address className="mt-4 space-y-3 text-base text-[#1e1e1a] not-italic">
                  <p className="font-benton-regular">The Sabal House</p>
                  <p>
                    <a
                      href="tel:1234567890"
                      className=" font-central-regular transition-opacity hover:opacity-60"
                    >
                      123.456.8790
                    </a>
                  </p>
                  <p>
                    <a
                      ...
                      className=" font-central-regular break-all transition-opacity hover:opacity-60"
                    >
                      info@sabalhouse.com
                    </a>
                  </p>
